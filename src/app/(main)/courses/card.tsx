...
const Card = ({ id, title, imgSrc, onClick, disabled, active }: Props) => {
    return (
        ...
        >
            ...
            <Image src={imgSrc} alt={title} height={70} width={93.33} className='rounded-lg drop-shadow-md border object-cover' />
